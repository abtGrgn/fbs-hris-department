...
(1, 'STI College San Pablo', 'sti@edu.ph', 9343434, 'Lopez Jaena', 'San Pablo City', 'Laguna', 4000, 'Philippines', 'sdfsdf', 'nhfh', '22222', 'dfgdfd', '2024-07-01 09:52:28', 1, '2024-07-04 09:29:19');
...
(37, 'aaaaaaaa', 1, '2024-07-02 15:04:21', '2024-07-04 14:27:18'),
...
INSERT INTO `fbs_hris_employees` (`employees_aid`, `employees_fname`, `employees_lname`, `employees_job_title_id`, `employees_department_id`, `employees_is_active`, `employees_created`, `employees_datetime`) VALUES
(10, 'Louren', 'Rubico', '29', '36', 1, '2024-07-04 15:09:45', '2024-07-04 15:09:45');
...
(31, '5', 'jklbnjkl', 1, '2024-07-04 15:01:42', '2024-07-04 15:01:42');
...
--
ALTER TABLE `fbs_hris_employees`
  MODIFY `employees_aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `fbs_hris_job_level`
--
ALTER TABLE `fbs_hris_job_level`
  MODIFY `job_level_aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
