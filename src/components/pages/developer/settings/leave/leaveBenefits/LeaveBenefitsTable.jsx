...
const LeaveBenefitsTable = ({ setLeaveBenefitsEdit }) => {
  ...
  const {
    ...
    queryKey: ["leaveBenefits", onSearch, store.isSearch],
    queryFn: async ({ pageParam = 1 }) =>
      await queryDataInfinite(
        `/v2/leaveBenefits/search`, // search endpoint
        `/v2/leaveBenefits/page/${pageParam}`, // list endpoint
    ...
    <>
      ...
      {store.isArchive && (
        <ModalArchive
          ...
          queryKey={"leaveBenefits"}
          mysqlEndpoint={`/v2/leaveBenefits/active/${id}`}
          item={isData}
          archive={isArchiving}
        />
      )}
      {store.isDelete && (
        <ModalDelete
          ...
          queryKey={"leaveBenefits"}
          mysqlEndpoint={`/v2/leaveBenefits/${id}`}
          item={isData}
        />
      )}
      {store.isRestore && (
